  ...
  return (
    <div className="space-y-3">
      {workouts.map((workout, index) => (
        ...
        >
          <div className="relative rounded-xl bg-white/80 backdrop-blur-sm p-4">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 group-hover:text-purple-400 transition-colors">
                    {workout.title}
                  </h4>
